...
async function getData() {
    ...
    const data = await axios.get(
        'https://api.coindesk.com/v1/bpi/historical/close.json?start=2017-01-01&end=2020-02-12'
    );
    return data;
}
...
async function cleanData() {
    ...
    const smaData = getSMAData(rawData, 100);
    console.log({ smaData });

    const surface = { name: 'BTC', tab: 'Charts' };
